...
# 2
message = "www.google.com.tr"
message = message.split("w.com")
print (message)

# 3
message = "Python Kursu: Baştam Sona Python Programlama Rehberiniz (40 Saat)"
...
# 7
course = "Python Kursu: Baştam Sona Python Programlama Rehberiniz (40 Saat)"
